...
- syntax_ok: `True`
- classes: `ToolRegistry`
- functions: `get_tool_registry, __init__, _load_registry_data, _resolve_tool_class, get_tool_class, resolve, list_tools, list_by_category, get_categories, clear_cache`
