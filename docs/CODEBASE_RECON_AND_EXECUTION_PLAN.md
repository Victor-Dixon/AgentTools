...
**Historical snapshot notice (reviewed 2026-07-03):** This document contains useful prior analysis, but several path claims are stale in the current checkout, including references to a present `kanban-scheduler/` directory and a nested `family-focus-board/` directory. Use `docs/root/MASTER_TASK_LOG.md`, `NEXT_UP.md`, `MASTER_TASK_LIST.md`, `ROADMAP.md`, `PROJECT_STRUCTURE.md`, and `docs/architecture/DOMAIN_MODEL.md` for current execution status and domain boundaries.
